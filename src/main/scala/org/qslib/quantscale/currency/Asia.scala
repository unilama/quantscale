...
object Asia {
   ...
   */
  lazy val CNY = Currency("Chinese yuan", "CNY", 156, "Y", "", 100, Rounding(), "%3% %1$.2f")
   ...
   */
  lazy val HKD = Currency("Honk Kong dollar", "HKD", 344, "HK$", "", 100, Rounding(), "%3% %1$.2f")
   ...
   */
  lazy val INR = Currency("Indian rupee", "INR", 356, "Rs", "", 100, Rounding(), "%3% %1$.2f")
   ...
   */
  lazy val IQD = Currency("Iraqi dinar", "IQD", 368, "ID", "", 1000, Rounding(3), "%2% %1$.3f")
   ...
   */
  lazy val JPY = Currency("Japanese yen", "JPY", 392, "\u00a5", "", 100, Rounding(), "%3% %1$.0f")
   ...
   */
  lazy val KRW = Currency("South-Korean won", "KRW", 410, "W", "", 100, Rounding(), "%3% %1$.0f")
   ...
   */
  lazy val SAR = Currency("Saudi riyal", "SAR", 682, "SRls", "", 100, Rounding(), "%3% %1$.2f")
   ...
   * It is divided in 100 cents.
   */
  lazy val SGD = Currency("Singapore dollar", "SGD", 702, "S$", "", 100, Rounding(), "%3% %1$.2f")
